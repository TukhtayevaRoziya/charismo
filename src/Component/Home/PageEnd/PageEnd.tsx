...
import OclockApi from "./Oclock_Api/Oclock_Api";
      ...
      <div className={style.PageEnd}>
        <div className={style.block1 + " " + style.block_1}>
          ...
          <p className={style.text}>
            Инновационные решения для восстановления, питания и уходу за
            волосами головы, бровей и бороды
          </p>
          ...
          <div className={style.socialNetwork}>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={odnoklassniki} alt="Odnoklassniki img" />
            </a>
            <a
              className={style.link}
        ...
        <div className={style.block1 + " " + style.block_2}>
          <div className={style.blocks_group}>
            <div className={style.otherPageLinks}>
              <h1>Страницы</h1>
              <NavLink activeClassName={style.otherLinkActive} to="/charismo">
                Главная
              </NavLink>
              <NavLink activeClassName={style.otherLinkActive} to="/shop">
                Магазин
              </NavLink>
              <NavLink activeClassName={style.otherLinkActive} to="/answer">
                Вопросы и ответы
              </NavLink>
              <NavLink activeClassName={style.otherLinkActive} to="/reviews">
                Отзывы
              </NavLink>
              <NavLink activeClassName={style.otherLinkActive} to="/contact">
                Контакты
              </NavLink>
            </div>
            <div className={style.otherProductLinks + " " + style.sm}>
              <h1>Продукты</h1>
              <NavLink activeClassName={style.otherLinkActive} to="/dekobrow">
                Dekobrow
              </NavLink>
              <NavLink activeClassName={style.otherLinkActive} to="/dekoHai">
                DekoHair
              </NavLink>
              <NavLink activeClassName={style.otherLinkActive} to="/dekoPill">
                DekoPill
              </NavLink>
              <NavLink activeClassName={style.otherLinkActive} to="/dekoBeard">
                DekoBeard
              </NavLink>
            </div>
          ...
          <h1 className={style.otherLinkEndText}>
